/*
  # Board Game English Club Member Schema

  ## Overview
  This migration creates member profile and session tables for Board Game English Club,
  a table-based English participation project using board games and guided review.

  ## New Tables
  
  ### `member_profiles`
  Stores extended profile information for members

...
export const programs: Program[] = [
  ...
  },
  {
    ...
    outcome: 'Download one free sample PDF, then join the briefing group for current cards and future weekly releases.',
    ...
    proof: 'One free sample lowers friction; the monthly group creates a simple path for weekly releases.',
    faq: [
      ...
      { question: 'What do I get for ¥500 / month?', answer: 'Access to currently available briefing cards plus new weekly releases as they are published.' },
    ],
  },
];

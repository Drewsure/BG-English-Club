...
const copy = {
  en: {
    ...
    solutionCopy: 'Board Game English Club creates a supported table. The game supplies the situation; the group supplies patience; the conversation becomes useful.',
  ...
  ja: {
    ...
    solutionCopy: 'Board Game English Club は、サポートのあるテーブルを作ります。ゲームが状況を作り、グループが安心感を作り、会話が実用的になります。',

...
const page = {
  en: {
    ...
    sponsorMail: {
      subject: 'Sponsor a BG English Club table',
      body: 'I would like to ask about sponsoring a BG English Club table.\n\nOrganization / sponsor name:\nPreferred table type:\nMonthly budget:\nQuestions:',
    },
    workshopFlow: [
  ...
  ja: {
    ...
    workshopMail: {
      ...
      body: 'BG English Club の企業ワークショップについて相談したいです。\n\n組織名：\n人数：\n希望テーマ：\n希望日：\n予算感：\n質問：',
    },
    sponsorMail: {
      subject: 'BG English Club テーブルスポンサー相談',
      body: 'BG English Club のテーブルスポンサーについて相談したいです。\n\n団体名・お名前：\n支援したいテーブル：\n月予算：\n質問：',
    },
    workshopFlow: [

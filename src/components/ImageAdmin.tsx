...
const MOCK_ADMIN_CODES = ['BGE-ADMIN-2026', 'MSG-ADMIN-2026', 'preview-curator'];
    ...
    <main className="page-shell min-h-screen bg-[radial-gradient(circle_at_center,#fff7e7,#fbf7ef)]">
      {!unlocked ? (
        ...
        <>
          ...
          <footer className="mt-12 flex justify-between border-t border-[#f1d392] bg-[#fffdfa] px-5 py-8 text-sm text-[#6f6458]"><span><strong className="font-display text-[#b85422]">Board Game English Club</strong><br />Fukuoka Chapter</span><span className="text-right">Contact<br /><b className="text-[#c75b22]">ministarenglish@mail.com</b></span></footer>
        </>
      )}
    </main>
  );
